...
- 把确认卡当审批关卡：每个环节停下来等「继续」、每张卡都要用户回复才动——用户打的字比自己干还多。卡片只在架构级不确定时出，其余转假设；能预填交付的先交付。
- 人工确认点当保险丝乱插：不可逆动作前才需要人，其余暂停只是把责任推回给用户，运行时每次都卡在等人。
- 试跑当门槛：会话内试跑修不好就不交付——交付是带着未达标清单交付，不是不交。
