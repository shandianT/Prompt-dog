...
| 档 | 环境 | 产物 | 额外验收 |
|---|---|---|---|
| 高保真 | 有 design / dataviz / 画布类技能 | flow JSON → 画布或图片，随附 JSON | 五问数字与 JSON 节点计数一致 |
| 文本图 | 只能输出代码块 | 七列泳道表 + Mermaid（上节模板；JSON 可折叠附上） | 七列齐，且 Mermaid 无语法错 |
| 泳道表 | 连代码块都不渲染 | 只有七列表：id / 泳道 / 名称 / 谁做 / 标记 / 原来 / 怎么解 | 七列齐 |
