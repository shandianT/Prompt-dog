...
import {
  ...
  FLAG_LABEL, KIND_LABEL, LANE_LABEL,
  type Flow, type FlowNode,
} from '../flow'

/**
 * 契约自检页：schema、示例数据、TypeScript 类型、x-compat 四条规则，四者是不是真的对得上。
 * 这不是产品界面——产品的 01 首页长什么样见设计画布。
 */
  ...
  return (
    <div>
      <header className="mb-6">
        <h1 className="text-title font-extrabold tracking-tight">契约自检</h1>
